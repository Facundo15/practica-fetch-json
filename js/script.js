...
function showData(dataArray) {
  ...
  for (const item of dataArray) {
    ...
    container.innerHTML += `<p> ${item.name} ${item.lastname} - Edad: ${item.age}</p>`; // Se concatena cada párrafo de la manera que queremos mostrarlo al innerHTML del contenedor
  }
}
